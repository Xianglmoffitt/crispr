...
export COUNT_DIR_1="$PROJECT_DIR/mageck_bam_unique_count"
#export COUNT_DIR_2="$PROJECT_DIR/magec_bam_count_trim_2"
export FILE_LIST="$PROJECT_DIR/mageck_compare_list"
export OUT_DIR_1="$PROJECT_DIR/mageck_test_unique_bam"
#export OUT_DIR_2="$PROJECT_DIR/magec_bam_test_out_2"

cd $PROJECT_DIR

while read INPUT CONTROL; do
	mageck test -k $COUNT_DIR_1/"$INPUT"_"$CONTROL"_unique.count.txt -t $INPUT -c $CONTROL -n $OUT_DIR_1/"$INPUT"_"$CONTROL"_unique_test
